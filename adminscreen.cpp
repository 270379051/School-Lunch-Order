...
void adminreview() {//function for admin to review parents comoplaint
    ...
    string filename_to_append = complaintlist[option2 - 1];
    ofstream myfile_to_append(filename_to_append.c_str(), ios::app);
    if (myfile_to_append.is_open()) {
        ...
        reviewlist.push_back(filename_to_append); // Add to review list
...
void adminreviewstaff() {//function for admin to review staffs complaint
    ...
    string filename_to_append = staffComplaintList[option2 - 1];
    ofstream myfile_to_append(filename_to_append.c_str(), ios::app);
    if (myfile_to_append.is_open()) {
        cout << "Enter your response to the complaint: ";
        string response;
...
void changeMenu() {//function for admin to change menu
    int day, column;
...
void listOrdersFromSameDay() {//listing order form same day
...
void pendingPayment() {//function showing pending payment orders from pending payment list
